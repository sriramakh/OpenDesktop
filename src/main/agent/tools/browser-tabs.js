...
const BROWSER_TABS_TOOLS = [
  { name: 'tabs_list',            description: 'List all open browser tabs.',                          category: 'tabs', permissionLevel: 'read',      params: ['browser'],                                          execute: async (a) => { try { return await tabsList(a); }           catch(e){return `tabs_list error: ${e.message}`;} } },
  { name: 'tabs_navigate',        description: 'Navigate a browser tab to a URL or open a new tab.',   category: 'tabs', permissionLevel: 'sensitive', params: ['browser','url','windowIndex','tabIndex','newTab'],   execute: async (a) => { try { return await tabsNavigate(a); }       catch(e){return `tabs_navigate error: ${e.message}`;} } },
  { name: 'tabs_close',           description: 'Close a browser tab or matching tabs.',                category: 'tabs', permissionLevel: 'sensitive', params: ['browser','windowIndex','tabIndex','urlPattern','duplicatesOnly'], execute: async (a) => { try { return await tabsClose(a); } catch(e){return `tabs_close error: ${e.message}`;} } },
  { name: 'tabs_read',            description: 'Read visible text content of a browser tab.',          category: 'tabs', permissionLevel: 'read',      params: ['browser','windowIndex','tabIndex','maxLength'],       execute: async (a) => { try { return await tabsRead(a); }           catch(e){return `tabs_read error: ${e.message}`;} } },
  { name: 'tabs_focus',           description: 'Bring a browser tab to the foreground.',               category: 'tabs', permissionLevel: 'read',      params: ['browser','windowIndex','tabIndex'],                   execute: async (a) => { try { return await tabsFocus(a); }          catch(e){return `tabs_focus error: ${e.message}`;} } },
  { name: 'tabs_find_duplicates', description: 'Find duplicate tabs across browsers.',                 category: 'tabs', permissionLevel: 'read',      params: ['browser'],                                           execute: async (a) => { try { return await tabsFindDuplicates(a); } catch(e){return `tabs_find_duplicates error: ${e.message}`;} } },
  { name: 'tabs_find_forms',      description: 'Detect form fields on a web page.',                    category: 'tabs', permissionLevel: 'read',      params: ['browser','windowIndex','tabIndex'],                   execute: async (a) => { try { return await tabsFindForms(a); }      catch(e){return `tabs_find_forms error: ${e.message}`;} } },
  { name: 'tabs_fill_form',       description: 'Fill and optionally submit a web form.',               category: 'tabs', permissionLevel: 'sensitive', params: ['browser','windowIndex','tabIndex','fields','submit'], execute: async (a) => { try { return await tabsFillForm(a); }       catch(e){return `tabs_fill_form error: ${e.message}`;} } },
  { name: 'tabs_run_js',          description: 'Run JavaScript in a browser tab.',                     category: 'tabs', permissionLevel: 'sensitive', params: ['browser','windowIndex','tabIndex','code'],            execute: async (a) => { try { return await tabsRunJS(a); }          catch(e){return `tabs_run_js error: ${e.message}`;} } },
];
